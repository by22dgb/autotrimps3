...
function autoRoboTrimp() {
    if (!(0 < game.global.roboTrimpCooldown) && game.global.roboTrimpLevel) {
        ...
        0 == a || game.global.world >= a && (game.global.world - a) % 5 == 0 && !checkIfLiquidZone() && !game.global.useShriek && (magnetoShriek(), MODULES.other.enableRoboTrimpSpam && debug("在区域"+game.global.world+"激活了小脆皮机器人的电磁尖啸", "graphs", "*podcast"))
    }
}
