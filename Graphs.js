const Graphs = {
	...
	UI: {
		...
		importExportGraphsDialog: function () {
			...
			var saveName = `脆皮图表 ${Object.keys(Graphs.portalSaveData)[0]} - ${Graphs.last(Object.keys(Graphs.portalSaveData))}`;
    ...
    <div class='btn btn-danger' id='downloadBtn'>Download as File</div></a>
		...
		createUI: function () {
			...
			for (const source of [`${atConfig.initialise.basepath}libs/highcharts.js`, `${atConfig.initialise.basepath}libs/boost.js`]) {
		...
		toggleDarkGraphs: function () {
			if (game) {
				...
				if (!darkcss && dark) {
					...
					b.type = "text/css";
					b.id = "dark-graph.css";
					b.href = graphsBasePath + "css/dark-graph.css";
