var ATversion='Zek v4.5.0',atscript=document.getElementById('AutoTrimps-script'),basepath='/autotrimps3/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
