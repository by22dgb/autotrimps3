...
function initializeAllSettings() {
    ...
    createSetting('Export60', '区域60以下的脚本设置', 'Gives you an AT settings String that you can use to import. Use if you are less than z60. ', 'infoclick', 'Export60', null, 'Import Export');
